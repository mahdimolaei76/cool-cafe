...
var QRCodeSvg = (0, import_react.forwardRef)(function(_ref, ref) {
  ...
  return import_react.default.createElement("svg", _extends({}, props, {
    height: size,
    ref,
    viewBox: "0 0 ".concat(viewBoxSize, " ").concat(viewBoxSize),
    width: size,
    xmlns
  }), title ? import_react.default.createElement("title", null, title) : null, import_react.default.createElement("path", {
    d: bgD,
    fill: bgColor
...
qrcode_default.stringToBytes = function(s) {
...
var QRCode = (0, import_react.forwardRef)(function(_ref, ref) {
  ...
  return import_react.default.createElement(QRCodeSvg, _extends({}, props, {
    bgColor,
